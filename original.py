...
questions_for_python = [
    ...
    {'text': 'Для чего в Python используется встроенная функция enumerate()?', 'all_answers': ['Для определения количества элементов последовательности.', 'Для одновременного итерирования по самим элементам и их индексам.', 'Для сортировки элементов по значениям id.'], 'right_answer': 1},
    ...
    {'text': 'Что выведет на экран следующий код?\na, *b, c = [1, 2]\nprint(a, b, c)', 'all_answers': ['[1] [] [2]', '1 0 2)', '1 [] 2', 'словарь (dict)'], 'Будет вызвано исключение: элементов в списке меньше, чем переменных.': 2},
